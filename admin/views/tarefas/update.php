...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        if (isset($post) && $post['SendPostForm']):
            ...
            if (!$read->getResult()):
                header('Location: painel.php?exe=tarefas/index&empty=true');
            else:
        ...
        <div class="box-header" data-original-title>
            ...
            <div class="box-icon">
                <a href="painel.php?exe=tarefas/update&postid=<?=$postid;?>" class="" title="Atualizar/Refresh na página"><i class="halflings-icon refresh"></i></a>
