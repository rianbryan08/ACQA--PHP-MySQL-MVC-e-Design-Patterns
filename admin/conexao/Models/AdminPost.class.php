...
class AdminPost {
    ...
    private function setData() {
        ...
        if (isset($this->Data['post_description'])):
            $Description = $this->Data['post_description'];
        else:
            unset($this->Data['post_description']);
        endif;

        unset($this->Data['post_cover'], $this->Data['post_description'], $this->Data['post_content']);
...
//        $this->Data = array_map('trim', $this->Data);
        ...
        if (isset($this->Data['post_description'])):
            $this->Data['post_description'] = $Description;
        else:
            unset($this->Data['post_description']);
        endif;
