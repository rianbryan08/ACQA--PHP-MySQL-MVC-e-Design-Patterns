...
class Login {
    ...
    public function CheckLogin() {
        if (empty($_SESSION['userAdminlogin']) || $_SESSION['userAdminlogin']->user_level < $this->Level):
    ...
    private function getUser() {
        ...
        $read = new Read;
        $read->ExeRead(PREFIX."users", "WHERE user_email = :e AND user_password = :p", "e={$this->Email}&p={$this->Senha}");
    ...
    private function Execute() {
        ...
        $_SESSION['userAdminlogin'] = $this->Result;
