...
class Upload {
    ...
    function __construct($BaseDir = null) {
        self::$BaseDir = ( (string) $BaseDir ? $BaseDir : $_SERVER["DOCUMENT_ROOT"].'/uploads/');
     ...
     */
    public function Image(array $Image, $Name = null, $Width = null, $Folder = null, $MaxFileSize = null) {
        $this->File = $Image;
        ...
        $MaxFileSize = ( (int) $MaxFileSize ? $MaxFileSize : 2048 );

        if ($this->File['size'] > ($MaxFileSize * (1024 * 1024))):
            $this->Result = false;
            $this->Error = "Arquivo muito grande {$this->File['size']}, tamanho máximo permitido de {$MaxFileSize}MB";
        else:
    ...
    public function File(array $File, $Name = null, $Folder = null, $MaxFileSize = null) {
        ...
        $MaxFileSize = ( (int) $MaxFileSize ? $MaxFileSize : 1024 );
